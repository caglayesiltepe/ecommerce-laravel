<div class="offcanvas offcanvas-end" id="update-attributeValue-modal">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="exampleModalLabel">Özellik Güncelle</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
        <div class="offcanvas-body flex-grow-1">
            <form class="add-new-record pt-0 row g-2" id="attributeValueFormUpdate" name="attributeValueFormUpdate"
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input class="form-control" type="text" id="up-extra" name="extra">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label class="form-label">Özellik</label>
                        <select id="up-attribute_id" name="attribute_id" class="form-control form-select">
                ...
                <div class="col-sm-12">
                    <button type="button" onclick="updateForm()" id="attributeValueFormButton"
