    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
            <div class="nav-item mb-0">
                <a class="nav-item  d-flex align-items-center px-0">
                    <span class=" d-md-inline-block text-muted fw-normal">@yield('navbar_title','Yönetim Paneli')</span>
                </a>
            </div>
        </div>
                   ...
                   data-bs-toggle="dropdown">
                    @if($authUser && !empty($authUser->image))
                        <div class="avatar avatar-online">
                            <img src="{{asset('backoffice/images/admin/')}}/{{ $authUser->image }}"
                                 class="rounded-circle">
                        </div>
                    @else
                        <div class="avatar avatar-online">
                            <img src="{{asset('backoffice/images/admin/admin.png')}}" class="rounded-circle">
                        </div>
                    @endif
                </a>
                    ...
                    <li>
                        <div class="d-grid px-2 pt-2 pb-1">
                            <form action="{{ route('backoffice.logout') }}" method="POST">
                                @csrf
                                <button class="btn btn-sm btn-danger d-flex" type="submit"> <small class="align-middle">Çıkış Yap</small><i class="ti ti-logout ms-2 ti-14px"></i></button>
                            </form>
                        </div>
                    </li>
                </ul>
