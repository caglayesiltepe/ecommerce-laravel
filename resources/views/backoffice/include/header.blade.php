...
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/css/toastr.css"/>

<!-- Vendors CSS -->
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/vendor/libs/node-waves/node-waves.css"/>
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.12.1/css/jquery.dataTables.min.css">
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/vendor/libs/bootstrap-select/bootstrap-select.css" />
...
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css">
<!-- Vendor -->
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/vendor/libs/%40form-validation/form-validation.css"/>
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/vendor/libs/animate-css/animate.css" />
<link rel="stylesheet" href="{{asset('backoffice/')}}/assets/vendor/libs/sweetalert2/sweetalert2.css" />
