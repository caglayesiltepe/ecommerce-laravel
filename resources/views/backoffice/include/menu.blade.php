    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{route('backoffice.attribute-value.index')}}" class="menu-link">
        ...
        <li class="menu-item">
            <a href="#" class="menu-link">
                ...
                <div data-i18n="Mesajlar">Mesajlar</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons ti ti-messages"></i>
                <div data-i18n="Destek Talebi">Destek Talebi</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons ti ti-calendar"></i>
                <div data-i18n="Randevu Sistemi">Randevu Sistemi</div>
            </a>
        </li>
        <li class="menu-item">
        ...
        <!-- Components -->
        <li class="menu-header small">
            <span class="menu-header-text" data-i18n="SİPARİŞ">SİPARİŞ</span>
        </li>
        <!-- Cards -->
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
