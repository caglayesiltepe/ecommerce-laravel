...
(function () {
			...
			return {
				define: function (a, b) {
					...
					if (0 > z.getListenerIndex(c)) {
						...
						p.fn = c;
						p.priority = k;
						for (var x = z.length - 1; 0 <= x; x--) if (z[x].priority <= k) return z.splice(x + 1, 0, p), {removeListener: f};
						z.unshift(p)
					}
					...
					return function (k, p, f) {
						...
						if (y) {
							var x = y.listeners;
							if (x.length) for (var x = x.slice(0),
												   C, v = 0; v < x.length; v++) {
								if (y.errorProof) try {
									C = x[v].call(this, f, p, e, h)
								} catch (n) {
								} else C = x[v].call(this, f, p, e, h);
	...
	(function () {
		...
		var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
			g = /&/g, e = />/g, l = /</g, h = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
			p = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, f = function (a, z) {
		...
		CKEDITOR.tools = {
			arrayCompare: function (a, z) {
				...
				for (var b = 0; b < a.length; b++) if (a[b] != z[b]) return !1;
				return !0
			},
			...
			extend: function (a) {
				...
				for (var h = 1; h < b; h++) {
					...
					CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(n), function (b) {
						if (!0 === c || null == a[b]) if (!f || b in f) a[b] = n[b]
					})
				}
				return a
			},
			...
			buildStyleHtml: function (a) {
				a = [].concat(a);
				for (var b, c = [], f = 0; f < a.length; f++) if (b = a[f]) /@import|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
				return c.join("")
			},
			...
			transformPlainTextToHtml: function (a, b) {
				var c = b == CKEDITOR.ENTER_BR, f = this.htmlEncode(a.replace(/\r\n/g, "\n")),
					f = f.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = b == CKEDITOR.ENTER_P ? "p" : "div";
				if (!c) {
					var n = /\n{2}/g;
					if (n.test(f)) var k = "\x3c" + h + "\x3e", d = "\x3c/" + h + "\x3e",
			...
			indexOf: function (a, b) {
				if ("function" == typeof b) for (var c = 0, f = a.length; c < f; c++) {
					if (b(a[c])) return c
				} else {
					if (a.indexOf) return a.indexOf(b);
					c = 0;
					for (f = a.length; c < f; c++) if (a[c] === b) return c
				}
				return -1
			},
			search: function (a, b) {
			...
			normalizeCssText: function (a, b) {
				var c = [], f, h = CKEDITOR.tools.parseCssText(a, !0, b);
			...
			objectCompare: function (a, b, c) {
				...
				if (!a && !b) return !0;
				if (!a || !b) return !1;
				for (f in a) if (a[f] != b[f]) return !1;
				if (!c) for (f in b) if (a[f] != b[f]) return !1;
				return !0
			},
			...
			checkIfAnyArrayItemMatches: function (a, b) {
				for (var c = 0, f = a.length; c < f; ++c) if (a[c].match(b)) return !0;
				return !1
			},
			...
			keystrokeToArray: function (a, b) {
				var c = b & 16711680, f = b & 65535, h = CKEDITOR.env.mac, n = [], k = [];
				...
				return {display: n, aria: k}
			},
			transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
			getCookie: function (a) {
				a = a.toLowerCase();
				for (var b = document.cookie.split(";"), c, f, h = 0; h < b.length; h++) if (c = b[h].split("\x3d"), f = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), f === a) return decodeURIComponent(1 < c.length ? c[1] : "");
				return null
			},
			...
			getCsrfToken: function () {
				...
				if (!a || 40 != a.length) {
					...
					for (c = 0; c < a.length; c++) var f = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36), b = b + (.5 < Math.random() ? f.toUpperCase() : f);
					a = b;
			...
			normalizeMouseButton: function (a, b) {
				...
				for (var c = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE,
					4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], f = 0; f < c.length; f++) {
					var h = c[f];
			...
			convertBytesToBase64: function (a) {
				var b = "", c = a.length, f;
				for (f = 0; f < c; f += 3) {
					var h = a.slice(f, f + 3), n = h.length, k = [], d;
					if (3 > n) for (d = n; 3 > d; d++) h[d] = 0;
					k[0] = (h[0] & 252) >> 2;
					k[1] = (h[0] & 3) << 4 | h[1] >> 4;
			...
			style: {
				parse: {
					...
					_findColor: function (a) {
						var b = [], c = CKEDITOR.tools.array, b = b.concat(a.match(this._rgbaRegExp) || []),
			...
			array: {
				filter: function (a, b, c) {
					...
					return a.length === b.length
								   ...
								   b, c) {
					for (var f = 0; f < a.length; f++) if (b.call(c, a[f], f, a)) return !0;
					return !1
				}, zip: function (a, b) {
			...
			object: {
				...
				keys: function (a) {
					var b = Object.prototype.hasOwnProperty, c = [], f = CKEDITOR.tools.object.DONT_ENUMS;
					if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object" !== typeof a)) {
						b = [];
						if ("string" === typeof a) for (c = 0; c < a.length; c++) b.push(String(c));
						return b
					}
					for (var h in a) c.push(h);
					if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) for (h = 0; h < f.length; h++) b.call(a, f[h]) && c.push(f[h]);
					return c
				},
				...
				merge: function (a, b) {
					var c = CKEDITOR.tools, f = c.clone(a), h = c.clone(b);
			...
			$: function (a) {
				...
				toString: function () {
					return CKEDITOR.tools.array.filter([this.width,
						this.style, this.color], function (a) {
						return !!a
					}).join(" ")
				}
			}, statics: {
	...
	CKEDITOR.dtd = function () {
		var a = CKEDITOR.tools.extend, d = function (a, b) {
				...
				table: 1,
				ul: 1
			}, e = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, l = {}, h = {"#": 1},
			k = {center: 1, dir: 1, noframes: 1};
		a(b, {
			a: 1,
			abbr: 1,
			area: 1,
		...
		a(d, {
			$block: a({audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1}, g, k),
			$blockLimit: {
				article: 1,
				aside: 1,
				audio: 1,
	...
	(function (a) {
		...
		a.removeCustomData = function (a) {
			var c = this.$["data-cke-expando"], c = c && d[c], g, e;
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
		appendTo: function (a, d) {
			...
			do if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || !g && !b.isEmpty()) c++, g = b.type == CKEDITOR.NODE_TEXT; while (b = b.getPrevious());
			return c
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
			...
			for (var b =
				...
				var g = a[c];
				if (d) for (var e = -1, l = 0; l < b.childNodes.length; l++) {
					var h = b.childNodes[l];
					if (!0 !== d || 3 != h.nodeType || !h.previousSibling || 3 != h.previousSibling.nodeType) if (e++, e == g) {
						b = h;
						break
					}
	...
	CKEDITOR.dom.element.clearMarkers = function (a, d, b) {
		var c = d.getCustomData("list_marker_names"), g = d.getCustomData("list_marker_id"), e;
	...
	(function () {
		...
		var g = document.createElement("_").classList, g = "undefined" !== typeof g &&
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			is: function () {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					var g = this.$.getBoundingClientRect(), l = f.$.documentElement,
						v = l.clientTop || d.$.clientTop || 0, n = l.clientLeft || d.$.clientLeft || 0, H = !0;
				...
				} else for (v = this, n = null; v && "body" != v.getName() &&
				"html" != v.getName();) {
				...
				e = a.getWindow();
				d = v(this, e);
				var q = v(a, e), I = this.$.offsetHeight;
				f = this.$.offsetWidth;
				var K = a.$.clientHeight, m = a.$.clientWidth;
			...
			getFrameDocument: function () {
				...
				if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) {
					var d = f.ownerDocument.createEventObject(), e;
					for (e in b) d[e] = b[e];
					f.fireEvent(c,
						d)
				} else f[f[a] ? a : c](b)
	...
	(function () {
		function a(a, b) {
			...
			f = c.endContainer;
			var e = c.startOffset, g = c.endOffset, h, y = this.guard, m = this.type,
		...
		var g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, e = CKEDITOR.dom.walker.whitespaces(),
			l = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp(), k = function (a) {
		...
		CKEDITOR.dom.walker.empty = function (a) {
			return function (b) {
				for (var c = 0, f = b.getChildCount(); c < f; ++c) if (!p(b.getChild(c))) return !!a;
				return !a
			}
		};
	...
	(function () {
		...
		function d(a, b, c, d, e) {
			...
			function n() {
				...
				for (a = 0; a < f; a++) if (b = S[a], c = t[a], !b.equals(c)) return a;
				return a - 1
			}

			function h() {
				var b = O - 1, c = F && E && !m.equals(G);
			...
			a.optimizeBookmark();
			var l = 0 === b, p = 1 == b, k = 2 == b;
			b = k || p;
			var m = a.startContainer, G = a.endContainer,
				L = a.startOffset, A = a.endOffset, M, r, F, E, w, Q;
			if (k && G.type == CKEDITOR.NODE_TEXT && (m.equals(G) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(G))) c.append(a.document.createText(G.substring(L, A))); else {
		...
		var e = {
				...
				u: 1,
				"var": 1
			}, l = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, k = CKEDITOR.dom.walker.editable(),
		...
		CKEDITOR.dom.range.prototype =
			{
				clone: function () {
					...
					var c = this.startContainer, d = this.endContainer, e = this.collapsed, g, n, h, l;
					...
					else if (1 > e) b = b.getPreviousSourceNode(); else {
					...
					switch (a) {
						...
						case CKEDITOR.ENLARGE_ELEMENT:
							...
							var n = this.getCommonAncestor(), h = this.root, l, p, k, m, G, L = !1, A, M;
							...
							for (k = c(k); k || m;) {
								...
								for (; m;) if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious(); else {
									if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), d.test(M) && (m = null), A = /[\s\ufeff]$/.test(M); else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
										M = m.getText();
										if (d.test(M)) m = null; else for (var r = m.$.getElementsByTagName("*"), F = 0, E; E = r[F++];) if (!CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]) {
											m = null;
											break
										}
										m && (A = !!M.length)
							...
							for (; k || m;) {
								...
								for (; m;) {
									A = !1;
									if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), g(m, 0) || (m = null), A = /^[\s\ufeff]/.test(M); else if (m.type == CKEDITOR.NODE_ELEMENT) {
										if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
											M = m.getText();
											if (d.test(M)) m =
												null; else for (r = m.$.getElementsByTagName("*"), F = 0; E = r[F++];) if (!CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]) {
												m = null;
												break
											}
											m && (A = !!M.length)
						...
						case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
							...
							var w, Q,
								...
								t = null, O = function (a) {
									if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (t) {
										if (t.equals(a)) {
											t = null;
											return
										}
							...
							if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
								k = this.clone();
								k = new CKEDITOR.dom.walker(k);
								var J = CKEDITOR.dom.walker.whitespaces(), u = CKEDITOR.dom.walker.bookmark();
					...
					if (!this.collapsed) {
						...
						var g = this.clone(), n = this.startContainer, h = this.endContainer, l = this.startOffset,
							k = this.endOffset,
							p = c = 1;
						...
						var g = new CKEDITOR.dom.walker(g), m = CKEDITOR.dom.walker.bookmark(),
					...
					var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
						d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, g = d.block,
						n = null;
					...
					return {previousBlock: e, nextBlock: g, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: n}
					...
					var c = this.startContainer, d = this.startOffset;
					...
					var c = this.endContainer, d = this.endOffset;
					...
					var c, d = 0, e, g, n = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
				...
				moveToElementEditEnd: function (a) {
					...
					function a(b, c) {
						var d = CKEDITOR.tools.array.map(b, function (a) {
							return a
						}), e = new CKEDITOR.dom.range(c.root), f, g, h;
					...
					return void 0 !== this.document.getSelection ? function (d) {
						var e = this.root.getDocument().$.createRange(), g;
					...
					var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], g, n, h, l;
					if (c && c.find) for (n = c.find(a), g = 0; g < n.count(); g++) if (c = n.getItem(g), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				if (!this._.started) {
					...
					l = v.startPath();
					var n = v.endPath(), H = !v.collapsed && c(v, l.block), q = !v.collapsed && c(v, n.block, 1);
				...
				for (this._.nextNode = null; n;) {
					var H = 0, q = n.hasAscendant("pre"), I = n.type != CKEDITOR.NODE_ELEMENT, K = 0;
					if (I) n.type == CKEDITOR.NODE_TEXT && g.test(n.getText()) && (I = 0); else {
						var m = n.getName();
						if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) {
							d = n;
							b(this, a, d);
							break
						} else if (n.isBlockBoundary(this.forceBrBreak && !q && {br: 1})) {
							if ("br" == m) I = 1; else if (!l && !n.getChildCount() && "hr" != m) {
								d = n;
								z = n.equals(v);
								break
							}
					...
					z = (!H || I) && n.equals(v);
					if (l && !H) for (; !n.getNext(h) && !z;) {
						m = n.getParent();
						if (m.isBlockBoundary(this.forceBrBreak && !q && {br: 1})) {
							H = 1;
							I = 0;
							z || m.equals(v);
	...
	(function () {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				g = b[f];
				g = "boolean" == typeof g ? {} : "function" == typeof g ? {match: g} : F(g);
				...
				for (r in Q) {
					m[r] = l(m[r], u) || null;
					var E = m, t = S[r], h = l(m[S[r]], u), n = m[r], w = [], B = !0, O = void 0;
					h ? B = !1 : h = {};
		...
		function c(a, b, c) {
			if (!a.match || a.match(b)) {
				...
				b = b.classes;
				if (a) {
					for (var d = !1, e = !0 === a, f = b.length; f--;) if (e || a(b[f])) b.splice(f, 1), d = !0;
					a = d
				} else a = !1;
		...
		function x(a, b, e, f) {
			...
			if (f.doCallbacks && a.elementCallbacks) {
				a:{
					...
					for (var t = 0, E = r.length, h; t < E; ++t) if (h = r[t](b)) {
						r = h;
						break a
					}
					r = void 0
			...
			if (f.doFilter) {
				a:{
					t = b.name;
					E = a._;
					a = E.allowedRules.elements[t];
					r = E.allowedRules.generic;
					t = E.disallowedRules.elements[t];
					E = E.disallowedRules.generic;
					h = f.skipRequired;
					var l = {
						valid: !1,
						validAttributes: {},
					...
					if (a || r) {
						z(b);
						if (t) for (w = 0, F = t.length; w < F; ++w) if (!1 === c(t[w], b, l)) {
							a = null;
							break a
						}
						if (E) for (w = 0, F = E.length; w < F; ++w) c(E[w], b, l);
						if (a) for (w = 0, F = a.length; w < F; ++w) d(a[w], b, l, h);
						if (r) for (w = 0, F = r.length; w < F; ++w) d(r[w], b, l, h);
						a = l
					} else a = null
				}
				...
				var O = a.validStyles;
				r = a.validClasses;
				var t = b.attributes, B = b.styles, E = b.classes;
				h = b.classBackup;
				var G = b.styleBackup, k, A, L = [], l = [], Q = /^data-cke-/;
				w = !1;
				delete t.style;
				delete t["class"];
				delete b.classBackup;
				delete b.styleBackup;
				if (!a.allAttributes) for (k in t) F[k] || (Q.test(k) ? k == (A = k.replace(/^data-cke-saved-/, "")) || F[A] || (delete t[k], w = !0) : (delete t[k], w = !0));
		...
		function K(a, b, c) {
			...
			if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(q()) : (a.parent && c.push({
				check: "it",
				el: a.parent
			}), a.remove()); else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !I(a.previous) && (b = q(), b.insertBefore(a)), a.next && !I(a.next) && (b = q(), b.insertAfter(a)), a.replaceWithChildren(); else {
				var d = a.children, e;
				b:{
					e = r[b];
					for (var f = 0, g = d.length, m; f < g; ++f) if (m = d[f], m.type == CKEDITOR.NODE_ELEMENT && !e[m.name]) {
						e = !1;
						break b
					}
					e = !0
		...
		function G(a, b) {
			var c = b.getDefinition(), d = c.attributes, e = c.styles, f, m, g, u;
			if (a.name != c.element) return !1;
			for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), g = a.classes.join("|"); u = c.pop();) {
		...
		var r = CKEDITOR.dtd, F = CKEDITOR.tools.copy, E = CKEDITOR.tools.trim, w = ["", "p", "br", "div"];
		...
		CKEDITOR.filter.prototype = {
			allow: function (b, c, d) {
				...
				var e = this, f = [], m = this.editor && this.editor.config.protectedSource, g, u = !1,
					t = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
				a.forEach(function (a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						if ("off" == a.attributes["data-cke-filter"]) return !1;
						if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (g = x(e, a, f, t), g & 1) u = !0; else if (g & 2) return !1
						...
						a:{
							...
							c = [];
							var r, E, h;
							if (m) for (E = 0; E < m.length; ++E) if ((h = d.match(m[E])) && h[0].length == d.length) {
								c =
									!0;
								break a
							}
							d = CKEDITOR.htmlParser.fragment.fromHtml(d);
							1 == d.children.length && (r = d.children[0]).type == CKEDITOR.NODE_ELEMENT && x(e, r, c, t);
							c = !c.length
						}
						c || f.push(a)
					}
				...
				for (; E = a.pop();) if (c = E.el, c.parent) switch (h = r[c.parent.name] || r.span, E.check) {
					case "it":
			...
			addContentForms: function (a) {
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						b = a[e];
						var f = void 0, m = void 0, g = void 0, u = void 0, t = void 0, r = void 0;
						c = [];
				...
				var u = CKEDITOR.tools.clone(e), t = [], r;
				if (!1 !== b && (r = this._.transformations[e.name])) {
					for (d =
							 0; d < r.length; ++d) m(this, e, r[d]);
					v(e)
				}
				x(this, u, t, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
		...
		var Q = {styles: 1, attributes: 1, classes: 1},
			...
			O = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, J = /^cke:(object|embed|param)$/,
			u = /^(object|embed|param)$/, B;
		B = CKEDITOR.filter.transformationsTools = {
			sizeToStyle: function (a) {
				...
				if ("string" == typeof b) a.name = b; else {
					var c = b.getDefinition(), d = c.styles, e = c.attributes, f, m, g, u;
					a.name = c.element;
					for (f in e) if ("class" ==
						f) for (c = a.classes.join("|"), g = e[f].split(/\s+/); u = g.pop();) -1 == c.indexOf(u) && a.classes.push(u); else a.attributes[f] = e[f];
	...
	CKEDITOR.scriptLoader = function () {
		...
		return {
			load: function (b, c, g, e) {
				...
				l && (b = [b]);
				g || (g = CKEDITOR);
				var h = b.length, k = h, p = [], f = [], y = function (a) {
	...
	CKEDITOR.resourceManager.prototype = {
		add: function (a, d) {
			...
			for (var c = this.loaded, g = this.registered, e = [], l = {}, h = {}, k = 0; k < a.length; k++) {
				var p = a[k];
				if (p) if (c[p] || g[p]) h[p] = this.get(p); else {
			...
			CKEDITOR.scriptLoader.load(e,
				function (a, e) {
					...
					for (var f = 0; f < a.length; f++) for (var g = l[a[f]], k = 0; k < g.length; k++) {
						var n = g[k];
						h[n] = this.get(n);
						c[n] = 1
					}
		...
		return function (b, c, g) {
			var e = {}, l = function (b) {
				a.call(this, b, function (a) {
					...
					var b = [], f;
					for (f in a) {
						var h = a[f], z = h && h.requires;
						if (!d[f]) {
							if (h.icons) for (var x = h.icons.split(","), C = x.length; C--;) CKEDITOR.skin.addIcon(x[C], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + x[C] + ".png");
	...
	(function () {
		...
		function y(a) {
			...
			CKEDITOR.plugins.load(d.split(","),
				function (b) {
					...
					for (var m in b) {
						var g = b[m], l = g.lang, k = null, t = g.requires, O;
						CKEDITOR.tools.isArray(t) && (t = t.join(","));
						if (t && (O = t.match(h))) for (; t = O.pop();) CKEDITOR.error("editor-plugin-required", {
							plugin: t.replace(",", ""),
							requiredBy: m
						});
		...
		function x(a, b) {
			...
			for (var e = new CKEDITOR.dom.documentFragment, f, g, h, l = 0; l < a.length; l++) {
				var k = a[l], r = k.startContainer.getAscendant("tr", !0);
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			plugins: {
				...
				if (c) {
					...
					if (c.fakeKeystroke) d.push(c.fakeKeystroke); else for (var g in f) f[g] === e && d.push(g)
				}
				return b ? d : d[0] || null
			}, addFeature: function (a) {
		...
		CKEDITOR.htmlParser.prototype = {
			onTagOpen: function () {
				...
				for (var c, g, e = 0, l; c = this._.htmlPartsRegex.exec(b);) {
					g = c.index;
					if (g > e) if (e = b.substring(e, g), l) l.push(e); else this.onText(e);
					e = this._.htmlPartsRegex.lastIndex;
					if (g = c[1]) if (g = g.toLowerCase(), l && CKEDITOR.dtd.$cdata[g] && (this.onCDATA(l.join("")), l = null), !l) {
						this.onTagClose(g);
						continue
					}
					if (l) l.push(c[0]); else if (g = c[3]) {
			...
			function (e, l, h) {
				function k(a) {
					...
					if (0 < n.length) for (var c = 0; c < n.length; c++) {
						var d = n[c], e = d.name, f = CKEDITOR.dtd[e], g = q.name && CKEDITOR.dtd[q.name];
				...
				var C = new CKEDITOR.htmlParser,
					...
					n = [], H = [], q = v, I = "textarea" == v.name, K = "pre" == v.name;
					...
					if (a(f)) n.push(f); else {
						...
						if ("br" == e) H.push(f); else {
							for (; !(h = (g = q.name) ? CKEDITOR.dtd[g] || (q._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || q.isUnknown || h[e]);) if (q.isOptionalClose) C.onTagClose(g); else if (e in b && g in b) g = q.children, (g = g[g.length - 1]) && "li" == g.name || y(g = new CKEDITOR.htmlParser.element("li"), q), !f.returnPoint && (f.returnPoint = q), q = g; else if (e in CKEDITOR.dtd.$listItem &&
								!x(e, g)) C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !x(e, g)) !f.returnPoint && (f.returnPoint = q), q = q.parent; else if (g in CKEDITOR.dtd.$inline && n.unshift(q), q.parent) y(q, q.parent, 1); else {
								f.isOrphan = 1;
								break
							}
							k(e);
				...
				C.onText = function (a) {
					...
					if (!I && !e["#"] && b in d) C.onTagOpen(g[b] || ""), C.onText(a); else {
						p();
						k();
						K || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
		...
		a.prototype = {
			add: function (a, c, d) {
				...
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					e = Array.prototype.slice.call(arguments, 1), l = this.rules, h = l.length, k, p, f, y;
				for (y = 0; y < h; y++) if (d && (k = c.type, p = c.name), f = l[y], !(a.nonEditable && !f.options.applyToAll ||
	...
	(function () {
		function a(a, d) {
			...
			function t(a, d) {
				return function (g) {
					if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var u = [], m = b(g), t, h;
						if (m) for (r(m, 1) && u.push(m); m;) e(m) && (t = c(m)) && r(t) && ((h = c(t)) && !e(h) ? u.push(t) : (f(E).insertAfter(t), t.remove())), m = m.previous;
			...
			var h = {elements: {}}, E = "html" == d, w = CKEDITOR.tools.extend({}, m), F;
		...
		CKEDITOR.htmlDataProcessor = function (b) {
			...
			c.addRules(G);
			c.addRules(L, {applyToAll: !0});
			c.addRules(a(b, "data"), {applyToAll: !0});
			e.addRules(A);
			e.addRules(M, {applyToAll: !0});
			e.addRules(a(b, "html"), {applyToAll: !0});
			b.on("toHtml", function (a) {
				a = a.data;
				var c = a.dataValue, e, c = n(c), c = v(c, b), c = f(c, Q), c = p(c), c = f(c, w),
					c = c.replace(t, "$1cke:$2"), c = c.replace(J, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
					c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
			...
			b.on("toDataFormat", function (a) {
				var c = a.data.dataValue, d = g.writer;
				d.reset();
		...
		var H =
				/(?:&nbsp;|\xa0)$/, q = "{cke_protected}", I = CKEDITOR.dtd,
			K = "caption colgroup col thead tfoot tbody".split(" "),
			m = CKEDITOR.tools.extend({}, I.$blockLimit, I.$block), G = {elements: {input: h, textarea: h}}, L = {
		...
		var r = /<(a|area|img|input|source)\b([^>]*)>/gi,
			F = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, E = /^(href|src|name)$/i,
			w = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
			Q = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, S = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
			t = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
			O = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, J = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
		n = function () {
			function a(c) {
	...
	(function () {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
				...
				var k, p;
				for (k in l) {
					for (h = l[k]; ;) if (p = a.onAttributeName(b, k)) if (p != k) delete l[k], k = p; else break; else {
						delete l[k];
						break
					}
				...
				b && this.filter(b);
				var e = this.name, l = [], h = this.attributes, k, p;
				a.openTag(e, h);
				...
				var d = null, l = CKEDITOR.tools.array.find(this.children, function (h) {
	...
	(function () {
		...
		CKEDITOR.inlineAll = function () {
			var a,
				d, b;
			for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), g = 0, e = c.count(); g < e; g++) a = c.getItem(g), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = {
				element: a,
				config: {}
	...
	(function () {
		...
		function b(a) {
			var b = a.name, d = a.element, l = a.elementMode, h = a.fire("uiSpace", {space: "top", html: ""}).html,
				k = a.fire("uiSpace", {space: "bottom", html: ""}).html,
		...
		CKEDITOR.editor.prototype.setMode = function (a, b) {
			...
			if (a != d.mode && l && l[a]) {
				...
				if (d.mode) {
					var h = d.checkDirty(), l = d._.previousModeData, k, p = 0;
					d.fire("beforeModeUnload");
					d.editable(0);
					d._.previousMode = d.mode;
					d._.previousModeData = k = d.getData(1);
					"source" == d.mode && l == k && (d.fire("lockSnapshot", {forceUpdate: !0}), p = 1);
		...
		CKEDITOR.editor.prototype.resize = function (a, b, d, l) {
			var h = this.container, k = this.ui.space("contents"),
			...
			var f = (l.$.offsetHeight || 0) - (k.$.clientHeight || 0), h = Math.max(b - (d ? 0 : f), 0);
			b = d ? b + f : b;
			k.setStyle("height", CKEDITOR.tools.cssLength(h));
			p && (p.style.width = "100%");
			this.fire("resize", {outerHeight: b, contentsHeight: h, outerWidth: a || l.getSize("width")})
		};
	...
	(function () {
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			base: CKEDITOR.dom.element, $: function (a, b) {
				...
				focus: function () {
					...
					var g, h;
					if (f) for (; (g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[e]);) if (g.getName() in
						CKEDITOR.dtd.span) {
						var f = b.splitElement(g), l = b.createBookmark();
						k(g);
						k(f);
						b.moveToBookmark(l)
				...
				fixInitialSelection: function () {
					...
					if (!this.is("textarea")) {
						...
						if (l) {
							var h = g.getHead(), r = h.getCustomData("stylesheet");
						...
						this.attachListener(a, "key", function (b) {
							...
							if (0 !== b.getRanges().length) {
								if (c in k) {
									var f, g = b.getRanges()[0], h = g.startPath(), r, l, B, c = 8 == c;
									CKEDITOR.env.ie &&
		...
		n = function () {
			...
			function b(c, d) {
				var e, f, g, h, r = [], l = d.range.startContainer;
				e = d.range.startPath();
				...
				w; ++k) e = F.getItem(k), a(e) ? (g = e.getName(), A && g in CKEDITOR.dtd.$list ? r = r.concat(b(e, d)) : (h = !!l[g], "br" != g || !e.data("cke-eol") || k && k != w - 1 || (Q = (f = k ? r[k - 1].node : F.getItem(k + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && E.$block[f.getName()]), -1 != p || h || (p = k), h || (n = k), r.push({
					...
					name: g,
					allowed: h
				}), f = Q = 0)) : r.push({isElement: 0, node: e, allowed: 1});
				-1 < p && (r[p].firstNotAllowed = 1);
				-1 < n && (r[n].lastNotAllowed = 1);
				return r
			}

			function d(b, c) {
				var e = [],
					f = b.getChildren(), g = f.count(), h, r = 0, l = E[c], k = !b.is(E.$inline) || b.is("br");
			...
			var E = CKEDITOR.dtd, w = {
				p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
				h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
			}, p = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({}, E.$inline);
			delete n.br;
			return function (t, w, J, u) {
				var B = t.editor, D = !1, y;
				...
				if (!u.checkReadOnly()) {
					...
					var D = w.range, z = w.mergeCandidates, x = "html" === w.type, q, C, T, H, Z;
					"text" == w.type &&
					...
					for (; (Z = e(D)) && a(Z) && Z.isBlockBoundary() && T.contains(Z);) D.moveToPosition(Z,
					...
					for (q = C.startNode; (q = q.getParent()) && f(q);) z.push(q);
					D.moveToBookmark(C);
					y = t.getHtml();
					y = "" === y || y.match(v);
					...
					if (t = J) {
						...
						if ((V = t.startPath().block) && (1 != V.getChildCount() || !V.getBogus())) a:{
							...
							if (1 == u.getChildCount() && a(P = u.getFirst()) && P.is(p) && !P.hasAttribute("contenteditable")) {
								...
								t = 0;
								for (y = V.count(); t < y; t++) if (B = V.getItem(t), !B.is(n)) break a;
						...
						for (F(B, P); y < B.length; y++) {
							...
							if (x) J = 0 < y; else {
								...
								if (C && D.isElement) {
									...
									if (x) q && (K = P.splitElement(q), w.zombies.push(K), w.zombies.push(q)); else {
										q = u.getName();
										ba = !y;
										x = y == B.length - 1;
										q = d(D.node, q);
					...
					if (ba) for (; N = ba.pop();) CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(R.document.createText(" "));
				...
				list: {
					detectMerge: function (a, b) {
						var d = c(b, a.bookmark),
							e = d.startPath(), f = d.endPath(), g = e.contains(CKEDITOR.dtd.$list),
						...
						if (a.mergeListBookmark) {
							...
							if (a.mergeList) {
								var h = f.contains(CKEDITOR.dtd.$list), l = g.contains(CKEDITOR.dtd.$list);
					...
					function a(c) {
						...
						g.guard = function (a,
							...
							if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && t && a.equals(t)) f = c.clone(), f.setStartAt(t, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
								if (k = !g) k = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!t || b(a, t));
								if (!k && (k = g)) if (a.is(d)) var k = h && h.getAscendant("table", !0),
									m = t && t.getAscendant("table", !0), p = a.getAscendant("table",
										!0), k = k && k.contains(p) || m && m.contains(p); else k = void 0;
					...
					return {
						detectPurge: function (a) {
							...
							var g = c(f, e.bookmark), h = g.clone(), l, t, k = g.getCommonAncestor();
	...
	(function () {
		...
		function p(a) {
			...
			var c = a.startContainer, d = a.getPreviousNode(k,
				null, c), e = a.getNextNode(k, null, c);
		...
		function C(a) {
			...
			return function (c) {
				...
				if (b[d]) {
					var e = a.getSelection(), f = e.getRanges()[0];
		...
		var n =
				"function" != typeof window.getSelection, H = 1, q = CKEDITOR.tools.repeat("​", 7),
			I = new RegExp(q + "( )?", "g"), K, m, G, L = CKEDITOR.dom.walker.invisible(1), A = function () {
				function a(b) {
					return function (a) {
		...
		CKEDITOR.on("instanceCreated", function (a) {
			...
			c.on("contentDom", function () {
				...
				var g = c.document, h = CKEDITOR.document, k = c.editable(), r = g.getBody(),
					m = g.getDocumentElement(), p = k.isInline(), F, x;
			...
			getNative: function () {
				...
				var a = n ? function () {
					...
					var b = function (b, c) {
						...
						for (var e = d.children, f, g, h = b.duplicate(), l = 0, k = e.length - 1, r = -1, m, p; l <= k;) if (r = Math.floor((l + k) / 2), f = e[r], h.moveToElementText(f), m = h.compareEndPoints("StartToStart", b), 0 < m) k = r - 1; else if (0 > m) l = r + 1; else return {
							container: d,
							offset: a(f)
						};
				...
				this.reset();
				if (c) for (var c = this.root, e, h = 0; h < a.length; ++h) e =
						...
						if (n) {
							...
							for (D = 0; D < a.length; D++) {
								...
								try {
									...
									if (0 <= q.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), B.setEnd(b.endContainer.$, b.endOffset); else throw q;
								}
								l.addRange(B)
							}
						}
	...
	(function () {
		...
		function b(c) {
			...
			if (c.collapsed) e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
				var f = this.element, h = this._.definition, l, k = h.ignoreReadonly, m = k || h.includeReadonly;
				null ==
				...
				c.trim();
				var n = c.createBookmark(), x = n.startNode, y = n.endNode, q = x, r;
				if (!k) {
					var z = c.getCommonAncestor(), k = a(x, z), z = a(y, z);
					k && (q = k.getNextSourceNode(!0));
					z && (y = z)
				}
				for (q.getPosition(y) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
					k = !1;
					if (q.equals(y)) q = null, k = !0; else {
						var v = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
							z = v && "false" == q.getAttribute("contentEditable"), w = v &&
						...
						if (z && m && CKEDITOR.dtd.$block[v]) for (var A = q, F = g(A), G = void 0, I = F.length, K = 0, A = I && new CKEDITOR.dom.range(A.getDocument()); K < I; ++K) {
							var G = F[K], L = CKEDITOR.filter.instances[G.data("cke-filter")];
							if (L ? L.check(this) : 1) A.selectNodeContents(G), b.call(this, A)
						}
						F = v ? !p[v] || w ? 0 : z && !m ? 0 : d(q, y, h, Q) : 1;
						if (F) if (G =
							q.getParent(), F = h, I = f, K = l, !G || !(G.getDtd() || CKEDITOR.dtd.span)[I] && !K || F.parentRule && !F.parentRule(G)) k = !0; else {
							if (r || v && CKEDITOR.dtd.$removeEmpty[v] && (q.getPosition(y) | Q) != Q || (r = c.clone(), r.setStartBefore(q)), v = q.type, v == CKEDITOR.NODE_TEXT || z || v == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
								for (var v = q, M; (k = !v.getNext(E)) && (M = v.getParent(), p[M.getName()]) && d(M, x, h, S);) v = M;
								r.setEndAfter(v)
							}
						} else k = !0;
		...
		function C(a) {
			...
			for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || v(d, b[f])
		}
		...
		var A = {
				...
				audio: 1,
				video: 1
			}, r = /\s*(?:;\s*|$)/, F = /#\((.+?)\)/g, E = CKEDITOR.dom.walker.bookmark(0, 1),
		...
		CKEDITOR.style.prototype = {
			apply: function (a) {
				...
				if ("string" == typeof this.element ?
					...
					if (c._length) {
						for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? G(c[h], d) : c[h] == d) {
							if (!b) return !0
						} else if (b) return !1;
						if (b) return !0
					} else return !0
	...
	(function () {
		...
		CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
			var b = this.getRanges()[0], g = this.root.editor, e;
			if (this.root.editor._.shiftPressed || this.isFake || b.isCollapsed || b.startContainer.equals(b.endContainer)) e = !1; else if (0 === b.endOffset) e = !0; else {
			...
			$: function (a, b) {
				...
				parseInput: function (a) {
					if ("string" !== typeof a) this._.isValidColor = !1; else {
						...
						b && (a = b);
						var b = this._.extractColorChannelsFromHex(a), c = this._.extractColorChannelsFromRgba(a);
				...
				rgbToHsl: function (a, b, c) {
					...
					var d = c / CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE,
						g = Math.max(a, b, d), f = Math.min(a, b, d);
					c = g - f;
					var y = 0;
					switch (g) {
						case a:
	...
	CKEDITOR.dom.elementPath.prototype = {
		compare: function (a) {
			...
			var e = this.elements, l = e.length;
			d && (b ? c += 1 : --l);
			b && (e = Array.prototype.slice.call(e, 0), e.reverse());
			for (; c < l; c++) if (g(e[c])) return e[c];
			return null
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
		type: CKEDITOR.NODE_TEXT, getLength: function () {
			...
			var d = this.$.parentNode, b = d.childNodes.length, c = this.getLength(), g = this.getDocument(),
	...
	(function () {
		function a(a, c, d) {
			var e = a.serializable, l = c[d ? "endContainer" : "startContainer"], h = d ? "endOffset" : "startOffset",
			...
			createIterator: function () {
				...
				return {
					getNextRange: function (l) {
						...
						var h = a[e];
						if (h && 1 < a.length) {
							if (!e) for (var k = a.length - 1; 0 <= k; k--) d.unshift(a[k].createBookmark(!0));
							if (l) for (var p = 0; a[e + p + 1];) {
								var f = h.document;
								l = 0;
								...
								for (f = f.getById(d[p + 1].startNode); ;) {
									...
									if (f.equals(k)) l = 1; else if (c(k) || k.type == CKEDITOR.NODE_ELEMENT && k.isBlockBoundary()) continue;
									break
								}
								if (!l) break;
								p++
	...
	(function () {
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			getUiColor: function () {
				...
				return (this.setUiColor = function (a) {
					this.uiColor = a;
					var c = CKEDITOR.skin.chameleon, d = "", e = "";
		...
		var l = "cke_ui_color", h = [], k = /\$color/g;
...
*/
	...
	(function () {
		...
		function Z(a) {
			...
			})), c = b.getChild([0, 0, 0, 0, 0]), e =
				c.getChild(0), d = c.getChild(1);
		...
		function da(a) {
			function b(b) {
				var c = "rtl" == f.lang.dir, q = k.width, l = k.height,
					...
					A = l + (b.data.$.screenY - m.y) * (a._.moved ? 1 : 2), C = a._.element.getFirst(),
					C = c && parseInt(C.getComputedStyle("right"), 10), v = a.getPosition();
				v.x = v.x || 0;
				v.y = v.y || 0;
		...
		function O(a, b, c) {
			var e = a.parts.dialog.getParent().getClientSize(), d = a.getSize(), f = a._.viewportRatio,
				g = Math.max(e.width -
					d.width, 0), e = Math.max(e.height - d.height, 0);
		...
		var y = CKEDITOR.tools.cssLength,
			U, u, V = !1, D = !CKEDITOR.env.ie || CKEDITOR.env.edge,
		...
		CKEDITOR.dialog = function (a, b) {
			...
			function d(b) {
				if (n == CKEDITOR.dialog._.currentTop) {
					...
					q = l = 0;
					if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1; else if (c == CKEDITOR.ALT + 121 && !n._.tabBarMode && 1 < n.getPageCount()) I(n), q = 1; else if (-1 != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ?
		...
		var E = function (a, b, c) {
			for (var e = 0, d; d = a[e]; e++) if (d.id == b || c && d[c] && (d = E(d[c], b, c))) return d;
			return null
	...
	(function () {
		...
		CKEDITOR.ui.button.prototype = {
			render: function (a, b) {
				...
				var p = null, q = CKEDITOR.env, r = this._.id = CKEDITOR.tools.getNextId(), g = "", d = this.command, l,
					m, k;
				this._.editor = a;
				var e = {
	...
	(function () {
		...
		function x(a) {
			...
			function n(b, c) {
				...
				if (!d.getById("cke_pastebin")) {
					var p = a.getSelection(), n = p.createBookmarks();
			...
			function r() {
				if ("paste" == m.mainPasteEvent) return a.fire("beforePaste", {type: "auto", method: "paste"}), !1;
				a.focus();
				f();
			...
			function k(b) {
				var c = {type: "auto", method: "paste", dataTransfer: m.initPasteDataTransfer(b)};
			...
			var m = CKEDITOR.plugins.clipboard, l = 0, v = 0;
			(function () {
				a.on("key", p);
				a.on("contentDom", b);
			...
			(function () {
				function b(c, e, d, h, f) {
					...
					a.addCommand(e, d);
					a.ui.addButton && a.ui.addButton(c, {label: p, command: e, toolbar: "clipboard," + h});
					a.addMenuItems && a.addMenuItem(e, {label: p, command: e, group: "clipboard", order: f})
				}
		...
		function D(a) {
			...
			a.on("contentDom", function () {
				...
				function d(c, e) {
					c.select();
					u(a, {dataTransfer: e, method: "drop"}, 1);
				...
				var e = a.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(a), n = a.ui.space("top"),
					r = a.ui.space("bottom");
		...
		CKEDITOR.plugins.add("clipboard", {
			requires: "dialog,notification,toolbar", init: function (a) {
				...
				if (CKEDITOR.env.gecko) {
					var f = ["image/png", "image/jpeg", "image/gif"], g;
					a.on("paste", function (c) {
						var d = c.data, n = d.dataTransfer;
				...
				a.on("paste", function (b) {
					b = b.data;
					var c = a._.nextPasteType || b.type, f = b.dataValue, g,
					...
					if ("text" == c && "html" == g) f = w(a, f, d.get("plain-text")); else if (k && a.pasteFilter && !b.dontFilter || q) f = w(a, f, a.pasteFilter);
		...
		CKEDITOR.plugins.clipboard = {
			...
			getRangeAtDropPosition: function (a, b) {
				var c = a.data.$, d = c.clientX, f = c.clientY, g = b.getSelection(!0).getRanges()[0],
					e = b.createRange();
					...
					if (document.body.createTextRange) {
						...
						try {
							...
							if (h) {
								...
								var t = b.document.$.elementFromPoint(d, f), m = new CKEDITOR.dom.element(t), u;
		...
		CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
			...
			this._ = {
				...
				data: {}, files: [], nativeHtmlCache: "", normalizeType: function (a) {
					a = a.toLowerCase();
		...
		CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
			getData: function (a, b) {
				...
				if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a) if ("Text" == l && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired()) this._.fallbackDataTransfer.setData(a, b); else try {
					this.$.setData(a, b)
				} catch (c) {
				}
			}, storeId: function () {
				...
				function b(a) {
					var b = new CKEDITOR.htmlParser, f, g;
		...
		CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype = {
			isRequired: function () {
				...
				if (b) return c;
				var c = this._extractDataComment(c), d = null, d = a === this._customDataFallbackType ?
					...
					createPanel: function (c) {
						...
						if (!b.panel) {
							var f = this._.panelDefinition, e = this._.panelDefinition.block,
								...
								d = this._.panel = new CKEDITOR.ui.floatPanel(c, h, f), f = d.addBlock(b.id, e),
								a = this, g = c.getCommand(this.command);
							d.onShow = function () {
		...
		CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
			$: function (a, b) {
				...
				markItem: function (a) {
					...
					}, e = this._.getItems(), d, c, f = e.count() - 1; 0 <= f; f--) if (d = e.getItem(f), d.getAscendant(b) || (c = d, this._.focusIndex =
					...
					switch (e) {
						case "next":
							for (var d = this._.focusIndex, e = this._.getItems(),
									 c; c = e.getItem(++d);) if (c.getAttribute("_cke_focus") && c.$.offsetWidth) {
								this._.focusIndex = d;
								c.focus(!0);
								break
							}
	...
	(function () {
		...
		CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
			$: function (a, b, c, m) {
				...
				var g = b.getDocument();
				m = v(a, g, b, c, m || 0);
				var n = m.element, l = n.getFirst(), e = this;
				...
				addBlock: function (a, b) {
					...
					var n = this._.panel, l = n.showBlock(a);
					...
					var k = this.element, e = this._.iframe,
						...
						f = k.getDocument(),
						r = this._.parentElement.getPositionedAncestor(), t = b.getDocumentPosition(f),
						f = r ? r.getDocumentPosition(f) : {x: 0, y: 0}, q = "rtl" == this._.dir,
						d = t.x + (m || 0) - f.x, p = t.y + (h || 0) - f.y;
					...
					CKEDITOR.tools.setTimeout(function () {
						var a = CKEDITOR.tools.bind(function () {
							...
							var b = n.element.getWindow(), a = k.$.getBoundingClientRect(), b = b.getViewPaneSize(),
			...
			requires: "panelbutton,floatpanel", init: function (a) {
				function b(d) {
					...
					function z(d, w, e) {
						...
						if (d && e) for (e.addColor(d.substr(1).toUpperCase()),
					...
					var g = d.name, h = d.type, k = d.title, C = d.order, m = d.commandName;
					d = d.contentTransformations || {};
					var A = new CKEDITOR.style(r["colorButton_" + h + "Style"]),
						q = CKEDITOR.tools.getNextId() + "_colorBox", x = {type: h},
						y = new CKEDITOR.style(r["colorButton_" + h + "Style"], {color: "inherit"}), B = function () {
						...
						}(), u = l.getRowLimit(a) ? new l(a, "back" == h ? "background-color" : "color", B) : void 0, t;
					a.addCommand(m, {
						contextSensitive: !0, exec: function (a, d) {
							if (!a.readOnly) {
								var b = d.newStyle;
								a.removeStyle(y);
								a.focus();
					...
					a.ui.add(g, CKEDITOR.UI_PANELBUTTON, {
						...
						onBlock: function (d, b) {
							...
							b.element.getAscendant({html: 1}).setStyle("overflow", "hidden");
							CKEDITOR.ui.fire("ready", this);
							var e = b.keys, h = "rtl" == a.lang.dir;
							e[h ? 37 : 39] = "next";
							e[40] = "next";
							e[9] = "next";
							e[h ? 39 : 37] = "prev";
						...
						onOpen: function () {
							var d = a.getSelection(),
								b = d && d.getStartElement(), e = a.elementPath(b),
				...
				function c(b, c, f) {
					var g = [], h = r.colorButton_colors.split(","),
				...
				function v(a, b) {
					var c = a._.getItems(), g = a.element.findOne("[aria-selected]"),
						f = a.element.findOne("[cke_colorlast]");
					g && g.removeAttribute("aria-selected");
					if (f) f.setAttribute("aria-selected", !0); else for (g = 0; g < c.count(); g++) if (f = c.getItem(g), b && b == n.normalizeColor(f.getAttribute("data-value"))) {
						f.setAttribute("aria-selected", !0);
						break
					}
				}

				var r = a.config, p = a.lang.colorbutton;
				if (!CKEDITOR.env.hc) {
					b({
						name: "TextColor",
						type: "fore",
		...
		n = CKEDITOR.tools.createClass({
			$: function (a, b, c) {
				...
				colorNames: function (a) {
					...
					var b = /^(rgb|hsl)a\(/g.test(a), c = /^rgba\((\s*0\s*,?){4}\)$/g.test(a);
				...
				getElement: function () {
					...
					this.getElement().getChild(0).setAttributes({"aria-posinset": a, "aria-setsize": b})
				}
			}
		});
		...
		l = CKEDITOR.tools.createClass({
			$: function (a, b, c) {
				...
				countColors: function () {
					...
					this._.moveToBeginning(new n(this.editor, {color: a}, this.clickFn))
				}, addNewRow: function () {
					...
					var a = this._.countPanelElements(), b = this._.calculateFirstPosition(a);
	...
	CKEDITOR.plugins.add("menu", {
		requires: "floatpanel", beforeInit: function (m) {
	...
	(function () {
		...
		var k = k + (' onmouseover\x3d"CKEDITOR.tools.callFunction({hoverFn},{index});" onmouseout\x3d"CKEDITOR.tools.callFunction({moveOutFn},{index});" onclick\x3d"' + n + 'CKEDITOR.tools.callFunction({clickFn},{index}); return false;"\x3e') +
			...
			r = CKEDITOR.addTemplate("menuItem", k), p = CKEDITOR.addTemplate("menuArrow",
		...
		CKEDITOR.menu = CKEDITOR.tools.createClass({
			$: function (a, b) {
				...
				onShow: function () {
					var a = this.editor.getSelection(), b = a && a.getStartElement(), f = this.editor.elementPath(),
						c = this._.listeners;
					this.removeAll();
					...
					this.hide();
					if (a.onClick) a.onClick(); else a.command &&
					...
					var b = this._.subMenu, f = this.items[a];
				...
				add: function (a) {
					...
					var h = this.items, l = this.editor, g = this._.panel, e = this._.element;
					if (!g) {
						g = this._.panel =
		...
		CKEDITOR.menuItem = CKEDITOR.tools.createClass({
			$: function (a, b, c) {
				...
				render: function (a, b, f) {
					var k = a.id + String(b), h = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
						l = "", g = this.editor, e, d,
						m = h == CKEDITOR.TRISTATE_ON ? "on" : h == CKEDITOR.TRISTATE_DISABLED ?
							"disabled" : "off";
					this.role in {
						menuitemcheckbox: 1,
						menuitemradio: 1
	...
	CKEDITOR.plugins.add("contextmenu", {
		requires: "menu", onLoad: function () {
						...
						a.on("contextmenu", function (a) {
							...
							if (!f || !b) if (a.preventDefault(),
								...
								var c = a.getTarget().getDocument(),
									...
									b = !c.equals(CKEDITOR.document), c = c.getWindow().getScrollPosition(),
			...
			a.addCommand("contextMenu", {
				exec: function (a) {
					var d = 0, e = 0, b = a.getSelection().getRanges(),
	...
	(function () {
		...
		CKEDITOR.plugins.add("copyformatting", {
			lang: "ar,az,bg,cs,da,ar,ar-ch,el,en,en-au,eo,es-mx,et,eu,fa,fr,gl,hr,hu,it,ja,ko,ku,lv,nb,nl,oc,pl,pt,pt-br,ro,ru,sk,sq,sr,sr-latn,sv,tr,uk,vi,zh,zh-cn",
			...
			init: function (a) {
				...
				a.on("contentDom", function () {
					var b = a.getCommand("copyFormatting"), d = a.editable(), c = d.isInline() ? d : a.document,
				...
				a.copyFormatting.on("applyFormatting", function (e) {
					if (!e.data.preventFormatStripping) {
						var d = e.data.range, c = b._extractStylesFromRange(a, d), f = b._determineContext(d), g, h;
						if (a.copyFormatting._isContextAllowed(f)) for (h = 0; h < c.length; h++) f = c[h], g = d.createBookmark(), -1 === l(b.preservedElements, f.element) ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome ? c[h].removeFromRange(e.data.range, e.editor) : c[h].remove(e.editor) : u(f.element, e.data.styles) && b._removeStylesFromElementInRange(d,
		...
		CKEDITOR.plugins.copyformatting = {
			...
			commands: {
				copyFormatting: {
					exec: function (a, b) {
						var e = CKEDITOR.plugins.copyformatting, d = a.copyFormatting,
							...
							g = e._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
				...
				applyFormatting: {
					editorFocus: CKEDITOR.env.ie && !CKEDITOR.env.edge ? !1 : !0, exec: function (a, b) {
						var e = a.getCommand("copyFormatting"), d = b ? "keystrokeHandler" == b.from : !1,
			...
			_extractStylesFromElement: function (a, b) {
				var e = {}, d = [];
				do if (b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") && (e.element = b, a.copyFormatting.fire("extractFormatting", e, a) && e.styleDef && d.push(new CKEDITOR.style(e.styleDef)), b.getName && -1 !== l(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName()))) break; while ((b = b.getParent()) && b.type === CKEDITOR.NODE_ELEMENT);
				return d
			},
			...
			_removeStylesFromElementInRange: function (a, b) {
				for (var e = -1 !== l(["ol", "ul", "table"], b), d = new CKEDITOR.dom.walker(a), c; c = d.next();) if (c = c.getAscendant(b, !0)) if (c.removeAttributes(c.getAttributes()), e) break
			},
			_getSelectedWordOffset: function (a) {
				...
				function d(a, c) {
					...
					if (m) c ? n = 0 : (g = /([\.\b]*$)/, n = (k = g.exec(h)) ? k.index : h.length); else if (c && (n += 1, n > h.length)) return d(f);
					return {node: f, offset: n}
				}

				var c = /\b\w+\b/ig, f, g, h, m, k;
				h = m = k = a.startContainer;
				for (f = e(h); null != (g = c.exec(f));) if (g.index + g[0].length >= a.startOffset) return a = g.index, c = g.index + g[0].length, 0 === g.index && (g = d(h, !0), m = g.node, a = g.offset), c >= f.length && (f = d(h), k = f.node, c = f.offset), {
					startNode: m,
					startOffset: a,
					endNode: k,
					endOffset: c
			...
			_applyStylesToTextContext: function (a, b, e) {
				var d = CKEDITOR.plugins.copyformatting, c = d.excludedAttributesFromInlineTransform, f, g;
				CKEDITOR.env.webkit && !CKEDITOR.env.chrome && a.getSelection().selectRanges([b]);
				for (f = 0; f < e.length; f++) if (b = e[f], -1 === l(d.excludedElementsFromInlineTransform, b.element)) {
			...
			_applyFormat: function (a, b) {
				var e = a.getSelection().getRanges()[0],
					d = CKEDITOR.plugins.copyformatting, c, f;
				if (!e) return !1;
				if (e.collapsed) {
	...
	(function () {
		...
		function f(b) {
			...
			var g = a.editable(), e = a.config.editorplaceholder, d = /<body.*?>((?:.|[\n\r])*?)<\/body>/i,
				f = a.config.fullPage, a = a.getData();
		...
		CKEDITOR.plugins.editorplaceholder = {styles: "[" + c + "]::before {position: absolute;opacity: .8;color: #aaa;content: attr( " + c + " );}.cke_wysiwyg_div[" + c + "]::before {margin-top: 1em;}"};
	...
	(function (d) {
		...
		c.c = a;
		c.d = function (g, a, e) {
			if (!c.o(g, a)) Object[a0_0x3fc5("0x2e")](g, a, {enumerable: !0, get: e})
		};
		c.r = function (a) {
			if (typeof Symbol !== a0_0x3fc5("0x2d") && Symbol[a0_0x3fc5("0x50")]) Object[a0_0x3fc5("0x2e")](a, Symbol[a0_0x3fc5("0x50")], {value: "Module"});
		...
		c.t = function (a, b) {
			...
			c.r(e);
			Object.defineProperty(e, a0_0x3fc5("0x45"), {enumerable: !0, value: a});
			if (b & 2 && "string" != typeof a) for (var d in a) c.d(e, d, function (b) {
				return a[b]
		...
		(function () {
			CKEDITOR[a0_0x3fc5("0x18")][a0_0x3fc5("0x4f")]("exportpdf", {
				lang: "en", icons: a0_0x3fc5("0x3d"), hidpi: !0, isSupportedEnvironment: function () {
					return !CKEDITOR[a0_0x3fc5("0x19")].ie || 10 < CKEDITOR[a0_0x3fc5("0x19")][a0_0x3fc5("0x46")]
				}, beforeInit: function (a) {
					var c = a.config[a0_0x3fc5("0x31")], b = this.createTokenFetcher(a, c);
					b[a0_0x3fc5("0x14")]();
					...
					this.isSupportedEnvironment() && (a[a0_0x3fc5("0x27")](a0_0x3fc5("0x57"), {
						exec: function (f) {
							...
							f[a0_0x3fc5("0x4a")](a0_0x3fc5("0x57"), function (b) {
								...
								var c = b[a0_0x3fc5("0x56")], d = a0_0x3fc5("0x1f");
							...
							f[a0_0x3fc5("0x4a")](a0_0x3fc5("0x57"), function (b) {
								...
								var e = new XMLHttpRequest, h = a[a0_0x3fc5("0x4b")][a0_0x3fc5("0x11")] || "cke4";
								e[a0_0x3fc5("0x60")](a0_0x3fc5("0x2f"), g);
								e[a0_0x3fc5("0x3f")](a0_0x3fc5("0x4c"), a0_0x3fc5("0x15"));
								e[a0_0x3fc5("0x3f")](a0_0x3fc5("0x3b"),
									h);
								if (c) e.setRequestHeader(a0_0x3fc5("0x21"), c); else CKEDITOR[a0_0x3fc5("0x6c")](a0_0x3fc5("0x62"));
								e[a0_0x3fc5("0x0")] = a0_0x3fc5("0x1b");
								e[a0_0x3fc5("0xd")](b);
								k[a0_0x3fc5("0x58")]({progress: .5});
								d(e, k)
							}, null, null, 20);
						...
						toolbar: a0_0x3fc5("0x2c")
												 ...
												 c) {
					var b = {
						refreshInterval: a[a0_0x3fc5("0x33")] || 36E5, fetchToken: function () {
			...
			CKEDITOR[a0_0x3fc5("0x18")].exportpdf = {
				downloadFile: function (a, c) {
					if (CKEDITOR[a0_0x3fc5("0x19")].ie) {
						var b = new Blob([c], {type: a0_0x3fc5("0x30")});
	...
	(function () {
		...
		function m(b) {
			return {
				elements: {
					$: function (a) {
						var c = a.attributes, c = c && c["data-cke-realelement"], d = l(b, decodeURIComponent(c));
		...
		function l(b, a) {
			var c = [], d = /^cke:/i, e = new CKEDITOR.htmlParser.filter({
					elements: {
						"^": function (a) {
				...
				}), n = b.activeFilter, f = new CKEDITOR.htmlParser.basicWriter,
		...
		var h = CKEDITOR.htmlParser.cssStyle, g = CKEDITOR.tools.cssLength, k = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i;
		...
		CKEDITOR.editor.prototype.restoreRealElement = function (b) {
			...
			var a = decodeURIComponent(b.data("cke-realelement")), a = l(this, a),
	...
	(function () {
		...
		CKEDITOR.plugins.add("flash", {
			...
			init: function (a) {
				...
				a.ui.addButton &&
				a.ui.addButton("Flash", {label: a.lang.common.flash, command: "flash", toolbar: "insert,20"});
			...
			CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
				base: CKEDITOR.ui.panel.block, $: function (a, b) {
					...
					add: function (a, b, c) {
						...
						if (a) for (c = this.element.getDocument().getById(this._.items[a]).getFirst(); a =
							b.getItem(++d);) {
							if (a.equals(c)) {
								this._.focusIndex = d;
								break
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
			$: function (a) {
				...
				renderHtml: function (a) {
					...
					var l = CKEDITOR.env, g, f, d = "cke_" + this.id, e = CKEDITOR.tools.addFunction(function (b) {
						f && (a.unlockSelection(1), f = 0);
						g.execute(b)
					}, this), k = this;
					g = {
						id: d, combo: this, focus: function () {
							CKEDITOR.document.getById(d).getChild(1).focus()
						}, execute: function (b) {
							var c = k._;
							if (c.state != CKEDITOR.TRISTATE_DISABLED) if (k.createPanel(a), c.on) c.panel.hide(); else {
								k.commit();
								var d = k.getValue();
					...
					if (!this._.panel) {
						var b = this._.panelDefinition, c = this._.panelDefinition.block,
							e = b.parent || CKEDITOR.document.getBody(), g = "cke_combopanel__" + this.name,
							f = new CKEDITOR.ui.floatPanel(a, e, b), b = f.addListBlock(this.id, c), d = this;
						f.onShow = function () {
					...
					var c = "undefined" != typeof b ? b : a, e = this.label, c = c === e ? c : c + ", " + e;
				...
				hideGroup: function (a) {
					...
					if (this._.state != a) {
						var b = this.document.getById("cke_" + this.id), c = b.getElementsByTag("a").getItem(0);
	...
	(function () {
		function k(a, b) {
			var c = a.config, e = b.lang, d = new CKEDITOR.style(b.styleDefinition),
				f = new l({entries: b.entries, styleVariable: b.styleVariable, styleDefinition: b.styleDefinition}), g;
			a.addCommand(b.commandName, {
				exec: function (a, b) {
					var c = b.newStyle, d = b.oldStyle, e = a.getSelection().getRanges()[0], f = void 0 === c;
			...
			a.ui.addRichCombo(b.comboName, {
				...
				onClick: function (c) {
					...
					a.focus();
					a.fire("saveSnapshot");
					a.execCommand(b.commandName, {newStyle: f.getStyle(c), oldStyle: f.getStyle(d)});
					a.fire("saveSnapshot")
				},
				onRender: function () {
		...
		function n(a, b) {
			...
			var c = function (a, b) {
				var c = a.getDefinition().attributes, e = b.getDefinition().attributes;
		...
		function m(a) {
			var b = a.editor, c = a.range, e = a.style, d, f, g;
			d = b.elementPath();
		...
		var l = CKEDITOR.tools.createClass({
			$: function (a) {
				...
				getStyle: function (a) {
					...
					for (var c =
						b.elements, e = 0, d; e < c.length; e++) if (d = c[e], d = this._.findMatchingStyleName(a, d)) return d;
					return null
				}
			}, _: {
	...
	CKEDITOR.plugins.add("forms", {
		requires: "dialog,fakeobjects", onLoad: function () {
			...
			var a = b.lang,
				g = 0, h = {email: 1, password: 1, search: 1, tel: 1, text: 1, url: 1}, l = {
			...
			var a = b.dataProcessor, g = a && a.htmlFilter, a = a && a.dataFilter;
				...
				0 !== m && a.ui.addRichCombo("Format", {
					label: c.label, title: c.panelTitle, toolbar: "styles,20", allowedContent: n, panel: {
						...
						a.on("selectionChange", function (b) {
							...
							b = b.data.path;
							this.refresh();
							for (var c in d) if (d[c].checkActive(b,
								a)) {
			...
			init: function (a) {
				if (!a.blockless) {
					var c = new h(a, "justifyleft", "left"), b = new h(a,
							"justifycenter", "center"), f = new h(a, "justifyright", "right"),
	...
	(function () {
		...
		CKEDITOR.plugins.add("pagebreak", {
			requires: "fakeobjects", onLoad: function () {
				...
				var b = a.dataProcessor, g = b && b.dataFilter, b = b && b.htmlFilter,
				...
				g && g.addRules({
					elements: {
						div: function (a) {
							if (a.attributes["data-cke-pagebreak"]) c(a); else if (h.test(a.attributes.style)) {
								var b = a.children[0];
		...
		CKEDITOR.plugins.pagebreak = {
			createElement: function (a) {
				return a.document.createElement("div", {attributes: e(a.lang.pagebreak.alt)})
			}
		}
	})();
	(function () {
	...
	(function () {
		...
		CKEDITOR.plugins.add("pastetools", {
			requires: ["clipboard", "ajax"], beforeInit: function (a) {
				a.pasteTools = new q;
			...
			filters: {}, loadFilters: l, createFilter: function (a) {
				...
				return function (a, e) {
					var f = new CKEDITOR.htmlParser.basicWriter,
						g = new CKEDITOR.htmlParser.filter, h;
					d && (a = d(a, e));
				...
				if (a && a.config) {
					...
					b, "pasteFromWord_" + b, "pasteFromWord" + d.capitalize(b, !0)], f = d.array.find(f, function (a) {
	...
	(function () {
		CKEDITOR.plugins.add("pastefromgdocs", {
			requires: "pastetools", init: function (a) {
				var c = CKEDITOR.plugins.getPath("pastetools"), d = this.path;
				a.pasteTools.register({
					...
					handle: function (c, d) {
						var b = c.data, e = CKEDITOR.plugins.pastetools.getClipboardData(b, "text/html");
						b.dontFilter = !0;
		...
		CKEDITOR.plugins.add("pastefromlibreoffice", {
			requires: "pastetools", isSupportedEnvironment: function () {
				...
				if (this.isSupportedEnvironment()) {
					var d = CKEDITOR.plugins.getPath("pastetools"), f = this.path;
	...
	(function () {
		CKEDITOR.plugins.add("pastefromword", {
			requires: "pastetools", init: function (a) {
				var f = 0, e = CKEDITOR.plugins.getPath("pastetools"), h = this.path,
				...
				a.pasteTools.register({
					...
					handle: function (e, b) {
						var d = e.data, c = CKEDITOR.plugins.pastetools.getClipboardData(d, "text/html"),
	...
	(function () {
		function h(a) {
			var e = CKEDITOR.plugins.getPath("preview"), d = a.config, g = a.lang.preview.preview, f = function () {
				var a = location.origin, b = location.pathname;
			...
			return d.fullPage ? a.getData().replace(/<head>/, "$\x26" + f).replace(/[^>]*(?=<\/title>)/, "$\x26 \x26mdash; " + g) : d.docType +
				'\x3chtml dir\x3d"' + d.contentsLangDirection + '"\x3e\x3chead\x3e' + f + "\x3ctitle\x3e" + g + "\x3c/title\x3e" + CKEDITOR.tools.buildStyleHtml(d.contentsCss) + '\x3clink rel\x3d"stylesheet" media\x3d"screen" href\x3d"' + e + 'styles/screen.css"\x3e\x3c/head\x3e' + function () {
					var c = "\x3cbody\x3e", b = a.document && a.document.getBody();
					if (!b) return c;
		...
		CKEDITOR.plugins.preview = {
			createPreview: function (a) {
				var e, d, g, f = {dataValue: h(a)}, c = window.screen;
				...
				a = window.open(b, null, ["toolbar\x3dyes,location\x3dno,status\x3dyes,menubar\x3dyes,scrollbars\x3dyes,resizable\x3dyes",
					"width\x3d" + e, "height\x3d" + d, "left\x3d" + g].join());
				c && a && (a.location = c);
	...
	CKEDITOR.plugins.removeformat = {
		commands: {
				...
				exec: function (a) {
					for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), c = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), e = CKEDITOR.plugins.removeformat.filter, m = a.getSelection().getRanges(), n = m.createIterator(), p = function (a) {
						...
						var l = f.createBookmark(),
							b = l.startNode, d = l.endNode, k = function (b) {
								for (var c = a.elementPath(b), f = c.elements, d = 1, g; (g = f[d]) && !g.equals(c.block) && !g.equals(c.blockLimit); d++) h.test(g.getName()) && e(a, g) && b.breakParent(g)
							};
						k(b);
			...
			for (var c = a._.removeFormatFilters || [], e = 0; e < c.length; e++) if (!1 === c[e](h)) return !1;
			return !0
		}
	};
	...
	CKEDITOR.plugins.scayt = {
		charsToObserve: [{
			charName: "cke-fillingChar", charCode: function () {
				var a = CKEDITOR.version, c = [4, 5, 6], d = String.fromCharCode(8203), b = Array(8).join(d), e, f;
				if (!a) return d;
	...
	(function () {
		CKEDITOR.plugins.add("stylescombo", {
			requires: "richcombo", init: function (c) {
				var l = c.config, h = c.lang.stylescombo, e = {}, k = [], m = [];
				...
				c.ui.addRichCombo("Styles", {
					...
					onRender: function () {
						c.on("selectionChange", function (a) {
							...
							for (var f = 0, d = a.length, g; f < d; f++) {
								g = a[f];
								for (var h in e) if (e[h].checkElementRemovable(g, !0, c)) {
									h != b && this.setValue(h);
									return
								}
							}
					...
					refresh: function () {
						var a = c.elementPath();
						if (a) {
							for (var b in e) if (e[b].checkApplicable(a, c, c.activeFilter)) return;
							this.setState(CKEDITOR.TRISTATE_DISABLED)
						}
					},
					reset: function () {
	...
	(function () {
		...
		function B(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				var f = d.getRanges(), b = q(d), c = b[0].getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c),
					h = b[0].getParent().$.rowIndex, b = b[b.length - 1],
					a = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = [];
				d.reset();
				for (d = h; d <= a; d++) {
					for (var k = e[d], g = new CKEDITOR.dom.element(c.$.rows[d]), m = 0; m < k.length; m++) {
						var l = new CKEDITOR.dom.element(k[m]), n = l.getParent().$.rowIndex;
		...
		function y(d) {
			...
			var b = d.getRanges(), c = q(d), e = c[0], h = c[c.length - 1], c = e.getAscendant("table"),
				a = CKEDITOR.tools.buildTableMap(c), k, g, m =
					[];
			d.reset();
			var l = 0;
		...
		function z(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				...
				a:{
					...
					for (h = 0; k = b[h++];) if ((g = k.getPrevious()) &&
		...
		function x(d, f, b) {
			...
			var h = CKEDITOR.tools.buildTableMap(e), a = h.length, k = h[0].length, g = d.getParent().$.rowIndex,
				m = A(h, g, d), l;
			if (f) {
				var n;
				try {
			...
			f =
				d.getDocument();
			var r = g, p = n = 0, u = !b && new CKEDITOR.dom.documentFragment(f), w = 0;
			for (f = 0; f < c.length; f++) {
				l = c[f];
				var t = l.getParent(), y = l.getFirst(), v = l.$.colSpan, z = l.$.rowSpan, t = t.$.rowIndex,
					B = A(h, t, l), w = w + v * z, p = Math.max(p, B - m + v);
				n = Math.max(n, t - g + z);
				b || (v = l, (z = v.getBogus()) && z.remove(), v.trim(), l.getChildren().count() && (t == r || !y || y.isBlockBoundary && y.isBlockBoundary({br: 1}) || (r = u.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !r || r.is && r.is("br") || u.append("br")), l.moveChildren(u)), f ? l.remove() : l.setHtml(""));
				r = t
			}
			if (b) return n * p == w;
			u.moveChildren(d);
		...
		function C(d, f) {
			...
			if (f) return !0;
			var b = b[0], c = b.getParent(), e = c.getAscendant("table"), h = CKEDITOR.tools.buildTableMap(e),
				a = c.$.rowIndex, k = A(h, a, b), g = b.$.rowSpan, m;
			if (1 < g) {
				m = Math.ceil(g / 2);
				for (var g =
					Math.floor(g / 2), c = a + m, e = new CKEDITOR.dom.element(e.$.rows[c]), h = A(h, c), l, c = b.clone(), a = 0; a < h.length; a++) if (l = h[a], l.parentNode == e.$ && a > k) {
		...
		function E(d, f) {
			...
			var b = b[0], c = b.getParent(), e = c.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(e),
				h = A(e, c.$.rowIndex, b), a = b.$.colSpan;
			if (1 < a) c = Math.ceil(a / 2), a = Math.floor(a / 2); else {
		...
		CKEDITOR.plugins.tabletools =
			{
				requires: "table,dialog,contextmenu", init: function (d) {
					...
					b("cellMergeRight", f({
						...
						requiredContent: "td[colspan]", exec: function (a, b) {
						...
						tablecell: {
							label: c.cell.menu, group: "tablecell", order: 1, getItems: function () {
								var a = d.getSelection(), b = q(a), a = {
									...
									tablecell_merge: x(a, null, !0) ? CKEDITOR.TRISTATE_OFF :
										CKEDITOR.TRISTATE_DISABLED,
	...
	(function () {
		...
		function z(a, b) {
			...
			l > p && (c = l, l = p, p = c);
			for (c = g; c <= k; c++) for (g = l; g <= p; g++) d = new CKEDITOR.dom.element(e[c][g]),
		...
		function A(a, b) {
			var c = a.editable().find(".cke_table-faked-selection"),
				d = a.editable().findOne("[data-cke-table-faked-selection-table]"), e;
			a.fire("lockSnapshot");
		...
		function L(a) {
			var b = (a = a.editor || a.sender.editor) && a.getSelection(), c = b && b.getRanges() || [],
				d = c && c[0].getEnclosedNode(), d = d && d.type ==
					CKEDITOR.NODE_ELEMENT && d.is("img"), e;
			if (b && (A(a), b.isInTable() && b.isFake)) if (d) a.getSelection().reset(); else if (!c[0]._getTableElement({table: 1}).hasAttribute("data-cke-tableselection-ignored")) {
		...
		function w(a) {
			...
			if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				var e = a.editor || a.listenerData.editor, g = e.getSelection(1), k = I(e), h = a.data.getTarget(),
		...
		function N(a, b) {
			...
			var d = a.getSelection(), e = d.createBookmarks(), g = a.document, k = a.createRange(),
				h = g.getDocumentElement().$, f = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
		...
		function E(a) {
			var b = a.editor || a.sender.editor, c = b.getSelection();
		...
		q.prototype.getTableMap = function () {
			...
			a:{
				b = this.cells.last;
				var c = b.getAscendant("table"), d = r(b), c = CKEDITOR.tools.buildTableMap(c), e;
		...
		var H = {
			onPaste: function (a) {
				...
				var d = a.editor, e = d.getSelection(), g = v(e), k = e.isInTable(!0) && this.isBoundarySelection(e),
					h = this.findTableInPastedContent(d, a.data.dataValue), f, l;
				(function (a, b, d, c) {
					a = a.getRanges();
			...
			findTableInPastedContent: function (a, b) {
				...
				var d, e = C(a.cells.first), g = a._getTable(), k = {}, h, f, l, p;
				for (l = 0; l < c.length; l++) for (h = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++) if (f = new CKEDITOR.dom.element(c[l][p]), d = b[l] && b[l][p] ? new CKEDITOR.dom.element(b[l][p]) :
					null, f && !f.getCustomData("processed")) {
					if (d && d.getParent()) f.replace(d); else if (0 === p || c[l][p - 1]) (d = 0 !== p ? new CKEDITOR.dom.element(c[l][p - 1]) : null) && h.equals(d.getParent()) ? f.insertAfter(d) : 0 < e ? h.$.cells[e] ? f.insertAfter(new CKEDITOR.dom.element(h.$.cells[e])) : h.append(f) : h.append(f, !0);
			...
			getCellsBetween: z, keyboardIntegration: function (a) {
				...
				c.attachListener(c, "keydown", function (a) {
					...
					var g = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1, 13: 1},
						k = CKEDITOR.tools.extend({table: 1}, CKEDITOR.dtd.$tableContent);
					delete k.td;
					delete k.th;
					return function (h) {
						var f = h.data.getKey(), l = h.data.getKeystroke(), k, m = 37 === f || 38 == f, n, q, r;
						if (g[f] && !a.readOnly && (k = a.getSelection()) && k.isInTable() && k.isFake) {
							...
							if (36 < f && 41 > f) n[0].moveToElementEditablePosition(m ? q : r, !m), k.selectRanges([n[0]]); else if (13 !== f || 13 === l || l === CKEDITOR.SHIFT +
								13) {
				...
				c.attachListener(c, "keypress", function (c) {
					var e = a.getSelection(), g = c.data.$.charCode || 13 === c.data.getKey(), k;
	...
	(function () {
				...
				exec: function (a, d) {
					...
					if (f && f.name == b.name) f.edit(); else if (b.insert) b.insert({
						...
						var f = "function" == typeof b.defaults ? b.defaults() : b.defaults,
							f = CKEDITOR.dom.element.createFromHtml(b.template.output(f), a.document), g,
		...
		function S(a) {
			...
			if ("wysiwyg" == this.editor.mode) {
				var b = this.editor.editable(), c = this.instances, d, e, f, g;
				if (b) {
					...
					if (a && a.initOnlyNew) c = this.initOnAll(); else {
						...
						for (e = l.count(); d < e; d++) {
							...
							if (g = !this.getByElement(f, !0)) {
								a:{
									g = ba;
									for (var k = f; k = k.getParent();) if (g(k)) {
										g = !0;
										break a
									}
									g = !1
			...
			return {
				toBeWrapped: b, iterator: function (a) {
					...
					if (n = c.length) {
						...
						for (k = 0; k < n; ++k) if (f = c[k], l = {}, g = f[0](a, l)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(l)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1
					}
				}
			}
		}
		...
		function W(a) {
			...
			b.on("drop", function (c) {
				...
				var f = c.data.dataTransfer, g = f.getData("cke/widget-id"), l = f.getTransferType(b),
					f = b.createRange(), k = function (a) {
						a = a.getBoundaryNodes().startNode;
						a.type !== CKEDITOR.NODE_ELEMENT && (a = a.getParent());
						return b.widgets.getByElement(a)
					}(c.data.dropRange);
				if ("" !== g && l === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS) c.cancel(); else if (l == CKEDITOR.DATA_TRANSFER_INTERNAL) if ("" === g && 0 < b.widgets.selected.length) c.data.dataTransfer.setData("text/html", F(b)); else if (g = a.instances[g]) e(g, k) ? c.cancel() : (f.setStartBefore(g.wrapper),
		...
		function U(a) {
			...
			b.on("contentDom", function () {
				var c =
					b.editable(), d = c.isInline() ? c : b.document, e, f;
			...
			b.on("doubleclick", function (b) {
				...
				if (d && !h.getNestedEditable(d.wrapper, b.data.element)) return d.fire("doubleclick", {element: b.data.element})
			}, null, null, 1)
		}
		...
		function V(a) {
			a.editor.on("key", function (b) {
				...
				c ? e = c.fire("key", {keyCode: b.data.keyCode}) : d && (c = b.data.keyCode, b = d.focusedEditable, c == CKEDITOR.CTRL +
		...
		function O(a) {
			if (!0 === a.mask) ma(a); else if (a.mask) {
				var b = new CKEDITOR.tools.buffers.throttle(250, na, a), c = CKEDITOR.env.gecko ? 300 : 0, d, e;
				a.on("focus", function () {
					b.input();
		...
		function ja(a) {
			if (a.draggable) {
				var b =
					a.editor, c = a.wrapper.getLast(h.isDomDragHandlerContainer), d;
		...
		function oa(a) {
			function b() {
				...
				var c = k;
				b = a.sender;
				var d = this.repository.finder, e = this.repository.liner, f = this.editor, g = this.editor.editable();
			...
			if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
				var c = this.repository.finder, d = this.repository.locator, e = this.repository.liner,
					f = this.editor, g = f.editable(), l = [], k = [], h, m;
		...
		function pa() {
			...
			CKEDITOR.style.addCustomHandler({
				type: "widget", setup: function (a) {
					...
					h = a.elementPath();
					if (this.checkApplicable(h, a)) for (var k = 0, n = this.group.length; k < n; k++) {
		...
		h.prototype = {
			addClass: function (a) {
				...
				for (var b, c, d = 0; d < a.count(); d++) if (b = a.getItem(d), c = b.getAscendant(h.isDomWidgetWrapper), this.wrapper.equals(c)) return b;
				return null
			}, isInited: function () {
				return !(!this.wrapper ||
					!this.inited)
			...
			$: function (a, b) {
				...
				handle: function (a) {
					var b = this.copyBin, c = this.editor, d = this.container,
						...
						g = c.createRange(), h = this, k = CKEDITOR.env.mac && CKEDITOR.env.webkit, n = k ? 100 : 0,
		...
		CKEDITOR.tools.extend(CKEDITOR.fileTools, {
			addUploadWidget: function (a, c, f) {
				...
				if (f.fileToElement) a.on("paste", function (d) {
						d =
							d.data;
						var l = a.widgets.registered[c], k = d.dataTransfer, f = k.getFilesCount(),
							g = l.loadMethod || "loadAndUpload", e, n;
	...
	(function () {
		...
		CKEDITOR.plugins.add("uploadimage", {
			requires: "uploadwidget", onLoad: function () {
				...
				if (this.isSupportedEnvironment()) {
					var a =
						CKEDITOR.fileTools, e = a.getUploadUrl(c.config, "image");
